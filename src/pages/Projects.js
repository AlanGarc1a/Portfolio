  ...
  const projectList = [
    {
      ...
      website: "https://watchlisted.vercel.app/",
      githubIcon: <FiGithub />,
      ...
      techList: ["Next.js", "TypeScript", "Tailwind", "Prisma", "PostrgesSQL"],
    },
    {
      title: "Movieflix",
      ...
      linkIcon: <FiExternalLink />,
      description:
        "A single web application where users can browse their favorite movies and tv shows.",
      techList: [
        "React",
        "TypeScript",
        "styled-components",
    ...
    },
    {
      ...
      linkIcon: <FiExternalLink />,
      description:
        'My first portfolio website I"ve built to showcase my projects.',
